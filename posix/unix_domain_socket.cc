...
#if !defined(OS_NACL_NONSFI) && !defined(OS_MACOSX) && !defined(OS_FREEBSD)
      // The PNaCl toolchain for Non-SFI binary build and macOS do not support
      // ucred. macOS supports xucred, but this structure is insufficient.
      + CMSG_SPACE(sizeof(struct ucred))
#endif  // OS_NACL_NONSFI or OS_MACOSX or OS_FREEBSD
      ;
...
#endif  // !defined(OS_NACL_NONSFI) && !defined(OS_MACOSX) && !defined(OS_FREEBSD)
    }
  }
